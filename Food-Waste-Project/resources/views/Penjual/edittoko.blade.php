                ...
                <div class="col-md-5 border-right" style="background-color: #00ffd1;">
                    <div class="p-3 py-5">
                        ...
                        <div class="row mt-4">
                            ...
                            <!-- <div class="col-md-12"><label class="labels">Jam Buka Toko</label><input type="text" class="form-control" placeholder="enter address line 2" value=""></div>
                            <div class="col-md-12"><label class="labels">Email Toko</label><input type="text" class="form-control" placeholder="enter email id" value=""></div> -->
                        </div>
                        <div class="col-md-15">
